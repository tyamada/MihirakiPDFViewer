...
1. **PDFを開く**: ファイルピッカーを使って、端末またはiCloud Drive
   からPDFファイルを選択します。
2. **ページ移動**: スワイプでページを移動するか、スライダーを使って
   文書内を移動します。
3. **メニュー**: タップすると、メニューとスライダーの表示を切り替え
   られます。
4. **検索**: 検索バーに文字を入力して、PDF内の特定のテキストを検索
   します。
5. **ズーム**: ピンチ操作で表示を拡大または縮小できます。長押しして
   からドラッグすると、拡大した表示をスクロールできます。
...
- **v0.3.0** - 2026/08/23: UIを更新し、ズーム中のドラッグ操作を追加。
  表紙サイズの調整も修正。
